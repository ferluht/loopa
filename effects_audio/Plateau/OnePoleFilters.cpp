...
void OnePoleLPFilter::blockProcess(const float* inputBuffer,
                                   float* outputBuffer,
...
void OnePoleHPFilter::blockProcess(const float* inputBuffer,
                                   float* outputBuffer,
                                   const uint64_t blockSize)
{
    for (uint64_t i = 0; i < blockSize; ++i) {
...
void DCBlocker::blockProcess(const float *inputBuffer,
                             float *outputBuffer,
                             const uint64_t blockSize)
{
    for (uint64_t i = 0; i < blockSize; ++i) {
